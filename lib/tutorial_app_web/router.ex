defmodule TutorialAppWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TutorialAppWeb.Layouts, :root}
  ...
  if Application.compile_env(:tutorial_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TutorialAppWeb.Telemetry
